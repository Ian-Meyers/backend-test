...
class RouteServiceProvider extends ServiceProvider
{
    ...
    Route::group([
        ...
        'prefix' => 'api',
         ...
         //Route::apiResource('/books', 'BookController')->name('books.returnBookList', 'returnBookList');
        // Route::prefix('api')
        //      ->middleware('api')
        //      ->namespace($this->namespace)
        //      ->group(base_path('routes/api.php'));
        ...
        // Route::get('/books/{book}', 'BookController@returnSingleBook')->name('books.returnSingleBook');

        // Route::put('/books/{book}', 'BookController@updateSingleBook')->name('books.updateSingleBook');
